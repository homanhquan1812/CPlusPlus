...
int main()
{
	...
	newList.resize(3, 5); // Create 3 elements, each of which has the same variable = 5
	...
	// Example 5: front() and back()
	cout << "Example 5:" << endl; 

	int sumofFirstandLast = listforIntegers.front() + listforIntegers.back();
	// We can't use begin() and end() cause they are for iterator in vector

	cout << sumofFirstandLast;
